...
LITAPP.Application_cl = Class.create({
	...
	render_init_list: function() {
		this.db.getStudiengaenge(false);
	},
	...
	viewStudiengang: function(elem) {
		var studiengangId = $('.studiengang.active').data('id');
		this.db.getStudiengang(studiengangId, true);
	}
});
